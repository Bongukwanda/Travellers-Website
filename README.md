...
## Usage
This is used to display travel adventures and displays a form that allows one to send a question about the cities and or other items in the website.

## Contributions
More than welcome, with some comments to explain the changes and contributions made.
